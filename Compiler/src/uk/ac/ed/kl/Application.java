...
import uk.ac.ed.kl.generator.Generator;
import uk.ac.ed.kl.linker.Resolver;
import uk.ac.ed.kl.linker.Sizer;
import uk.ac.ed.kl.meta.CodeUnit;
import uk.ac.ed.kl.parser.FirstPassParser;
import uk.ac.ed.kl.parser.ParserContext;
import uk.ac.ed.kl.parser.SecondPassParser;
...
public final class Application
{
	 ...
	 */
	public static void main(String[] args) throws IOException, FormatException, CompilerError, ObjectFrozenException
	{		
		// Create the global parser context
		ParserContext globalContext = new ParserContext();
		...
		for (File file : inputFiles)
		{
			...
			} catch (CompilerError e) { globalContext.log.error(e); }
		}
